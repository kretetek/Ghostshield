...
if (!isset($_REQUEST["dropzone"])) {
	...
	if (!isset($page->model) || !isset($page->product)) {
		...
		<div id="banner">
			<div class="video_wrapper">
				<img src="//assets.'.$page->host.'/img/bottle-bg/hydrophobic.jpg" alt="header image hydrophobic concrete sealer" />
			</div>
		</div>
	...
	<div id="banner">
		<div class="video_wrapper">
			<img src="//assets.'.$page->host.'/img/bottle-bg/'.($page->product["waterproofs"]?'hydrophobic':"natural").'.jpg"  alt="header image '.($page->product["waterproofs"]?'hydrophobic':"natural look").' concrete sealer" />
		</div>
	</div>
	...
	<section id="product" itemscope itemtype="http://schema.org/Product">
        ...
        <div class="gs_column">test</div>
        <div class="gs_column_2"><div class="product">
...
echo "\n\t\t\t\t".$page->meta("category", $page->product["type"], true);
	...
	if ($page->product["residential"]) {
		echo '
						<a href="https://concretesealersolutions.com/product/'.str_replace(" ","-",strtolower($page->product["name"])) .'/" class="hex-button large big">'.$GLOBALS["buy_button_text"].' <!--small>via Concrete Sealer Solutions</small--></a>';
	} else {
		echo '
	...
	<section id="tech_docs">
		<div class="column full">
			<div class="column_interior">
				<h2 class="sub">Technical Documents</h2>
				<ul class="files">';
	...
	<section id="product_data" class="black_bg">
		<div class="multi_column">
			<div class="column left">
				<div class="column_interior">'.$page->product["technical"].'</div>
			</div>
...
if (!isset($_REQUEST["dropzone"])) {
	...
	<section id="videos" class="white videos">
		<div class="column full">
			<div class="column_interior">
				<h2 class="title centered">Ghostshield in Action</h2>
				<div class="videos">
	...
	<section id="comparison" class="white white_bg">
		<div class="column full">
			<div class="column_interior">
				<h2 class="centered sub">Product Comparisons</h2>
	...
	<section id="buy" class="black">
		<div class="column full">
			<div class="column_interior">
				<h2 class="sub centered">'. str_replace("Pro Line ", "", $GLOBALS["buy_section_title"]) .'</h2>
