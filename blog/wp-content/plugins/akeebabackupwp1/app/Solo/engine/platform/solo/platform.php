 ...
 */
class AEPlatformSolo extends AEPlatformAbstract
{
	...
	public function get_default_database_driver($use_platform = true)
	{
		...
		return 'AEDriver' . ucfirst($driver);
	}
	...
	public function log_platform_special_directories()
	{
		...
		AEUtilLogger::WriteLog(_AE_LOG_INFO, "Installation root  :" . $this->get_site_root());
	...
	public function apply_quirk_definitions()
	{
		...
		\AEUtilQuirks::addQuirkDef('011', 'critical', 'SOLO_AEQ_011', array('AEPlatformSolo', 'quirk_011'));
		// Missing database connection information for backup
		\AEUtilQuirks::addQuirkDef('012', 'critical', 'SOLO_AEQ_012', array('AEPlatformSolo', 'quirk_012'));
	...
	public static function quirk_011()
	{
		...
		$scriptingChain = AEUtilScripting::getDomainChain();
