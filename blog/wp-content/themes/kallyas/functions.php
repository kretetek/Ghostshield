...
--------------------------------------------------------------------------------------------------*/
	...
	if(function_exists('register_sidebar')){
		register_sidebar(array(
		'name'          => 'Product Page Contact Form',
		'id'            => 'product-page-contact-form',
		'before_widget' => '<div class="textwidget" style="width:480px; margin-top:50px;">',
		'after_widget' => '</div>'
		));
	}
	...
	if(function_exists('register_sidebar')){
		register_sidebar(array(
		'name'          => 'Product Page Inner Images',
		'id'            => 'product-page-inner-images',
		'before_widget' => '<div class="maindivnewinner" style="width:100%;">',
		'after_widget' => '</div>'
		));
	}
