...
$(function(){
	...
	$('.has_submenu').hover(function(){
		...
		$('.page_content').removeClass("dim");
	});

	/*$('.has_submenu').touchstart(function(){
		alert("test");
	}, function(){
		alert("untest");
	});*/
...
/*	new ResizeSensor(jQuery('#search'), function() {
	...
	$('#show_filters').click(function() {
		...
		$(this).html($('.nav-menu-products .menu_container').hasClass("open")?"Apply Filters":"Show Filters");
