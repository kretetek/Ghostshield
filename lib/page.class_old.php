	...
	<div id="container" class="'.$this->location['filename'].'">
		...
		<div id="main_nav_container">
			...
			<nav id="fs_nav">
				<div class="gs_wrapper">
					...
					<section class="gs_custom_section" id="gs_logo_section"><img src="http://assets.ghostshield.com/img/logo/ghostshield-logo-black-nt.svg" /></section>
					<section class="gs_custom_section" id="gs_search_section"><input type="search" /><input type="submit" /></section>
					<section class="gs_custom_section" id="gs_actions_section">
					</section>
					<section class="gs_custom_section" id="prod-section">
						<h3 class="gs_section_headline"><a href="#">Products</a></h3>
		...
		$html .= '
					...
					<section class="gs_custom_section" id="rec-section">
						<h3 class="gs_section_headline"><a href="#">Recommendations</a></h3>
		...
		$html .= '
					...
					<section class="gs_custom_section" id="wtb-section">
						<h3 class="gs_section_headline"><a href="/product_finder">Product Finder</a></h3>
						<h3 class="gs_section_headline"><a href="/documents">Technical Documents</a></h3>
						<h3 class="gs_section_headline"><a href="/nanotechnology">Technology</a></h3>
						<h3 class="gs_section_headline"><a href="/articles">Articles</a></h3>
						...
						<div class="menu_chunk">
							<h3 class="gs_section_headline"><a href="/photos">Customer Photos</a></h3>
							<h3 class="gs_section_headline"><a href="#">Commercial Projects</a></h3>
							<h3 class="gs_section_headline"><a href="/videos">Videos</a></h3>
						</div>
						<div class="menu_chunk">
							<h3 class="gs_section_headline"><a href="/distributors">Distributors</a></h3>
							<h3 class="gs_section_headline"><a href="/applicators">Applicators</a></h3>
						</div>
					</div>
